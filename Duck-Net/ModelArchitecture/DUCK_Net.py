...
from keras.layers import Conv2D, Dense, Flatten, UpSampling2D
...
def create_model(img_height, img_width, input_chanels, out_classes, starting_filters):
    ...
    segmentation_output = Conv2D(out_classes, (1, 1), activation="sigmoid", name="segmentation_output")(z1)

    # classification path
    flat = Flatten()(t53)
    fc = Dense(units=100, activation="relu")(flat)
    classification_output = Dense(units=3, activation="softmax", name="classification_output")(fc)
